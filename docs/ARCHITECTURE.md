...
> 참고: [Type safety in Kotlin DSL and Navigation Compose](https://developer.android.com/guide/navigation/design/type-safety) · [Migrating to type-safe destinations](https://developer.android.com/guide/navigation/type-safe-destinations)
...
> 참고: [android/nowinandroid — 공식 멀티모듈 레퍼런스 앱](https://github.com/android/nowinandroid) (구조는 참고하되, 이번 MVP는 이 저장소의 모듈 분리 방식을 그대로 따르지 않음)
...
> 참고: [Save data in a local database using Room](https://developer.android.com/training/data-storage/room)
...
> 참고: [Save key-value data with DataStore](https://developer.android.com/topic/libraries/architecture/datastore)
...
> 참고: [retrofit2-kotlinx-serialization-converter (JakeWharton)](https://github.com/JakeWharton/retrofit2-kotlinx-serialization-converter) — 2024-03-19부로 archived(read-only) 상태이므로, 향후 Kotlin/serialization 버전을 올릴 때 이 컨버터가 더 이상 업데이트되지 않는다는 점을 감안해야 한다. 문제가 생기면 Retrofit 공식 `kotlinx-serialization-converter`로의 이전을 검토할 것.
...
> 참고: [Dependency injection with Hilt](https://developer.android.com/training/dependency-injection/hilt-android) · [Migrate to built-in Kotlin](https://developer.android.com/build/migrate-to-built-in-kotlin) · [Hilt Gradle Plugin 2.58 is incompatible with AGP 9 (google/dagger#5083)](https://github.com/google/dagger/issues/5083) · [Hilt Gradle Plugin does not work with AGP 9.0.0-alpha04 (google/dagger#4944)](https://github.com/google/dagger/issues/4944) · [KSP uses kotlin.sourceSets DSL when using AGP Built-In Kotlin (google/ksp#2729)](https://github.com/google/ksp/issues/2729)
...
> 참고: [Kakao Map SDK - Getting started](https://developers.kakao.com/docs/latest/en/kakaomap/common) · [Kakao Android SDK - Getting started (devrepo 설정 포함)](https://developers.kakao.com/docs/latest/en/android/getting-started)
