...
public enum TourismCatalogCategory {
    ...
    RELATED("함께 찾는 관광지", "관광 빅데이터 기반 연관 관광지를 확인합니다."),
    HUBS("지역 관광 허브", "구·군별 방문 중심 관광지를 확인합니다."),
    CROWDING("관광지 혼잡도", "관광지별 예상 혼잡 정보를 확인합니다."),
    PHOTOS("부산 관광사진", "한국관광공사 관광사진을 둘러봅니다."),
    WALKING("부산 걷기 코스", "두루누비의 부산 걷기 여행길을 확인합니다."),
    AUDIO("오디오 관광", "부산 중심부 주변 오디오 관광 콘텐츠를 확인합니다.");
