...
data class GuideStrings(
    ...
    // STEP 상세 배너(GuideStepHero)에 얹는 부제 문구. 캐러셀 카드의 stepXSummary(짧고 실용적인 설명)와
    // 달리 배너용 후킹 카피(느낌표 톤)라 별도 필드로 둔다 — 배너 이미지에 더 이상 텍스트가 없어 언어별로
    // 이 문구가 그대로 노출된다.
    val stepEntryPreparationHeroSubtitle: String,
    val stepReservationInquiryHeroSubtitle: String,
    val stepHospitalCheckinHeroSubtitle: String,
    val stepTreatmentExaminationHeroSubtitle: String,
    val stepPaymentReceiptHeroSubtitle: String,
    val stepAftercareReturnCheckHeroSubtitle: String,
    // S-06 캐러셀 카드의 마스코트 말풍선 전용 2줄 문구. Lead는 일반 텍스트, Highlight는 강조(코랄) 텍스트로 렌더링된다.
    val stepEntryPreparationTipLead: String,
    val stepEntryPreparationTipHighlight: String,
    val stepReservationInquiryTipLead: String,
    val stepReservationInquiryTipHighlight: String,
    val stepHospitalCheckinTipLead: String,
    val stepHospitalCheckinTipHighlight: String,
    val stepTreatmentExaminationTipLead: String,
    val stepTreatmentExaminationTipHighlight: String,
    val stepPaymentReceiptTipLead: String,
    val stepPaymentReceiptTipHighlight: String,
    ...
    val medicalMaterialsPreparationTitle: String,
    ...
    val visitReceptionPreparation: VisitReceptionPreparationStrings,
    ...
    companion object {
        val Ko = GuideStrings(
            screenTitle = "이용 가이드",
            screenSubtitle = "진료 여정을 하나씩 준비해보세요",
            loadErrorFallback = "오류가 발생했습니다.",
            stepEntryPreparationTitle = "입국 전 준비",
            stepEntryPreparationSummary = "여권과 서류를 먼저 준비해보세요.",
            stepReservationInquiryTitle = "예약 및 문의",
            stepReservationInquirySummary = "병원 문의 전에 필요한 내용을 준비해보세요.",
            stepHospitalCheckinTitle = "병원 방문 및 접수",
            stepHospitalCheckinSummary = "방문 절차와 접수 준비를 확인해보세요.",
            stepTreatmentExaminationTitle = "진료 및 검사",
            stepTreatmentExaminationSummary = "진료 과정과 검사 준비를 확인해보세요.",
            stepPaymentReceiptTitle = "결제 및 수납",
            stepPaymentReceiptSummary = "결제 수단과 영수증을 확인해보세요.",
            stepAftercareReturnCheckTitle = "회복·귀국 준비",
            stepAftercareReturnCheckSummary = "회복 관리와 귀국 전 체크를 준비해보세요.",
            stepEntryPreparationHeroSubtitle = "여행 같은 치료, 준비부터 편하게!",
            stepReservationInquiryHeroSubtitle = "병원 문의 전에 필요한 내용을 준비해보세요!",
            stepHospitalCheckinHeroSubtitle = "병원 도착 후 접수 절차를 차근차근 진행해보세요!",
            stepTreatmentExaminationHeroSubtitle = "의료진 상담과 필요한 검사를 편안하게 받아보세요!",
            stepPaymentReceiptHeroSubtitle = "진료비와 수납 절차를 쉽고 명확하게 확인해보세요!",
            stepAftercareReturnCheckHeroSubtitle = "치료 후 회복과 귀국 준비를 안전하게 마무리해보세요!",
            stepEntryPreparationTipLead = "여권, 비자, 보험 서류를",
            stepEntryPreparationTipHighlight = "먼저 준비해요",
            stepReservationInquiryTipLead = "문의 전에 준비하면",
            stepReservationInquiryTipHighlight = "상담이 훨씬 쉬워져요!",
            stepHospitalCheckinTipLead = "여권과 예약 정보만 있으면",
            stepHospitalCheckinTipHighlight = "접수가 쉬워져요!",
            stepTreatmentExaminationTipLead = "방문 병원에",
            stepTreatmentExaminationTipHighlight = "먼저 문의해보세요",
            stepPaymentReceiptTipLead = "결제 후 영수증은",
            stepPaymentReceiptTipHighlight = "꼭 챙겨두세요",
            ...
            medinTipLabel = "메디인 팁",
            medicalMaterialsPreparationTitle = "의료자료 준비",
            ...
            visitReceptionPreparation = VisitReceptionPreparationStrings.Ko,
            treatmentExamination = TreatmentExaminationStrings.Ko,
            treatmentBriefingDefaults = TreatmentBriefingDefaultsStrings.Ko
        )
        val En = GuideStrings(
            screenTitle = "Guide",
            screenSubtitle = "Prepare your treatment journey, step by step",
            loadErrorFallback = "An error occurred.",
            stepEntryPreparationTitle = "Before You Arrive",
            stepEntryPreparationSummary = "Prepare your passport and documents first.",
            stepReservationInquiryTitle = "Reservation & Inquiry",
            stepReservationInquirySummary = "Prepare what you need before contacting a hospital.",
            stepHospitalCheckinTitle = "Hospital Visit & Check-in",
            stepHospitalCheckinSummary = "Check the visit process and what you need for check-in.",
            stepTreatmentExaminationTitle = "Treatment & Examination",
            stepTreatmentExaminationSummary = "Check the treatment process and what to prepare for tests.",
            stepPaymentReceiptTitle = "Payment & Receipt",
            stepPaymentReceiptSummary = "Check your payment method and receipt.",
            stepAftercareReturnCheckTitle = "Recovery & Departure Prep",
            stepAftercareReturnCheckSummary = "Prepare your recovery care and pre-departure checks.",
            stepEntryPreparationHeroSubtitle = "Treatment like travel — get ready with ease!",
            stepReservationInquiryHeroSubtitle = "Prepare what you need before contacting the hospital!",
            stepHospitalCheckinHeroSubtitle = "Go through check-in step by step after you arrive!",
            stepTreatmentExaminationHeroSubtitle = "Comfortably get consultations and the exams you need!",
            stepPaymentReceiptHeroSubtitle = "Easily and clearly check your treatment costs and payment steps!",
            stepAftercareReturnCheckHeroSubtitle = "Safely wrap up recovery and return preparations after treatment!",
            stepEntryPreparationTipLead = "Prepare your passport, visa,",
            stepEntryPreparationTipHighlight = "and insurance first",
            stepReservationInquiryTipLead = "Gather what you need",
            stepReservationInquiryTipHighlight = "before you reach out",
            stepHospitalCheckinTipLead = "With your passport and booking,",
            stepHospitalCheckinTipHighlight = "check-in is easy!",
            stepTreatmentExaminationTipLead = "Contact the hospital",
            stepTreatmentExaminationTipHighlight = "you visited first!",
            stepPaymentReceiptTipLead = "After paying, be sure to",
            stepPaymentReceiptTipHighlight = "keep your receipt",
            ...
            medicalMaterialsPreparationTitle = "Medical Records Prep",
            ...
            visitReceptionPreparation = VisitReceptionPreparationStrings.En,
            treatmentExamination = TreatmentExaminationStrings.En,
            treatmentBriefingDefaults = TreatmentBriefingDefaultsStrings.En
        )
        val Zh = GuideStrings(
            screenTitle = "使用指南",
            screenSubtitle = "请一步步准备您的诊疗之旅",
            loadErrorFallback = "发生错误。",
            stepEntryPreparationTitle = "入境前准备",
            stepEntryPreparationSummary = "请先准备好护照和材料。",
            stepReservationInquiryTitle = "预约与咨询",
            stepReservationInquirySummary = "请准备好联系医院前需要的内容。",
            stepHospitalCheckinTitle = "医院就诊与挂号",
            stepHospitalCheckinSummary = "请确认就诊流程与挂号准备事项。",
            stepTreatmentExaminationTitle = "诊疗与检查",
            stepTreatmentExaminationSummary = "请确认诊疗流程与检查准备事项。",
            stepPaymentReceiptTitle = "结算与收费",
            stepPaymentReceiptSummary = "请确认付款方式与收据。",
            stepAftercareReturnCheckTitle = "康复与回国准备",
            stepAftercareReturnCheckSummary = "请准备好康复护理与回国前检查。",
            stepEntryPreparationHeroSubtitle = "像旅行一样的治疗，从容准备！",
            stepReservationInquiryHeroSubtitle = "在联系医院前，请先准备好所需内容！",
            stepHospitalCheckinHeroSubtitle = "抵达医院后，请按步骤办理挂号！",
            stepTreatmentExaminationHeroSubtitle = "轻松接受医疗咨询和所需检查！",
            stepPaymentReceiptHeroSubtitle = "轻松清晰地确认诊疗费用和收费流程！",
            stepAftercareReturnCheckHeroSubtitle = "治疗后安全完成康复与回国准备！",
            stepEntryPreparationTipLead = "护照、签证、保险资料",
            stepEntryPreparationTipHighlight = "请提前准备",
            stepReservationInquiryTipLead = "联系医院前",
            stepReservationInquiryTipHighlight = "先备好这些信息",
            stepHospitalCheckinTipLead = "只要有护照和预约信息",
            stepHospitalCheckinTipHighlight = "挂号很简单！",
            stepTreatmentExaminationTipLead = "请先咨询",
            stepTreatmentExaminationTipHighlight = "您本次就诊的医院",
            stepPaymentReceiptTipLead = "付款后",
            stepPaymentReceiptTipHighlight = "请务必保留收据",
            ...
            medicalMaterialsPreparationTitle = "医疗资料准备",
            ...
            visitReceptionPreparation = VisitReceptionPreparationStrings.Zh,
            treatmentExamination = TreatmentExaminationStrings.Zh,
            treatmentBriefingDefaults = TreatmentBriefingDefaultsStrings.Zh
        )
        val Ja = GuideStrings(
            screenTitle = "利用ガイド",
            screenSubtitle = "診療の旅を一つずつ準備しましょう",
            loadErrorFallback = "エラーが発生しました。",
            stepEntryPreparationTitle = "入国前の準備",
            stepEntryPreparationSummary = "パスポートと書類をまず準備しましょう。",
            stepReservationInquiryTitle = "予約・問い合わせ",
            stepReservationInquirySummary = "病院への問い合わせ前に必要な内容を準備しましょう。",
            stepHospitalCheckinTitle = "病院訪問・受付",
            stepHospitalCheckinSummary = "訪問の流れと受付準備を確認しましょう。",
            stepTreatmentExaminationTitle = "診療・検査",
            stepTreatmentExaminationSummary = "診療の流れと検査の準備を確認しましょう。",
            stepPaymentReceiptTitle = "会計・支払い",
            stepPaymentReceiptSummary = "支払い方法と領収書を確認しましょう。",
            stepAftercareReturnCheckTitle = "回復・帰国準備",
            stepAftercareReturnCheckSummary = "回復ケアと帰国前チェックを準備しましょう。",
            stepEntryPreparationHeroSubtitle = "旅行のような治療、準備から気軽に！",
            stepReservationInquiryHeroSubtitle = "病院への問い合わせ前に必要な内容を準備しましょう！",
            stepHospitalCheckinHeroSubtitle = "病院到着後、受付手続きを一つずつ進めましょう！",
            stepTreatmentExaminationHeroSubtitle = "医療スタッフとの相談や必要な検査を安心して受けましょう！",
            stepPaymentReceiptHeroSubtitle = "診療費と精算手続きを簡単・明確に確認しましょう！",
            stepAftercareReturnCheckHeroSubtitle = "治療後の回復と帰国準備を安全に仕上げましょう！",
            stepEntryPreparationTipLead = "パスポート・ビザ・保険書類を",
            stepEntryPreparationTipHighlight = "先に準備しましょう",
            stepReservationInquiryTipLead = "問い合わせ前に",
            stepReservationInquiryTipHighlight = "必要な情報を確認",
            stepHospitalCheckinTipLead = "パスポートと予約情報があれば",
            stepHospitalCheckinTipHighlight = "受付も簡単です！",
            stepTreatmentExaminationTipLead = "受診した病院に",
            stepTreatmentExaminationTipHighlight = "まずお問い合わせください",
            stepPaymentReceiptTipLead = "支払い後は",
            stepPaymentReceiptTipHighlight = "領収書を必ず保管",
            ...
            medicalMaterialsPreparationTitle = "医療資料の準備",
            ...
            visitReceptionPreparation = VisitReceptionPreparationStrings.Ja,
...
data class PaymentMethodCheckStrings(
    ...
    companion object {
        val Ko = PaymentMethodCheckStrings(
            ...
            item2Title = "사용 가능한 결제 수단",
            item2Description = "카드, 현금, 계좌이체 등 실제 사용 가능한 결제 수단을 확인하세요.",
            item3Title = "카드 한도·해외결제 설정",
            item3Description = "결제 전에 카드 한도와 해외 사용 차단 여부를 미리 확인하세요.",
            item4Title = "보험 직불·GOP",
            item4Description = "보험사와 병원 간 직접 정산(GOP)이 가능한지 사전에 확인하세요.",
            item5Title = "결제 위치",
            item5Description = "응급실, 외래, 입원 등 어디에서 수납하는지 확인하면 더 편리해요.",
        ...
        val En = PaymentMethodCheckStrings(
            ...
            item1Title = "Payment Currency",
            item1Description = "Many hospitals charge in Korean won, so check the actual billing currency.",
            item2Title = "Available Payment Methods",
            item2Description = "Check which payment methods — card, cash, bank transfer — are actually accepted.",
            item3Title = "Card Limit & Overseas Payment Setting",
            item3Description = "Before paying, check your card limit and whether overseas use is blocked.",
            item4Title = "Insurance Direct Billing (GOP)",
            item4Description = "Check in advance whether direct settlement (GOP) between your insurer and the hospital is available.",
            item5Title = "Payment Location",
            item5Description = "Knowing where to pay — ER, outpatient, or inpatient — makes things easier.",
        ...
        val Zh = PaymentMethodCheckStrings(
            ...
            item2Title = "可用付款方式",
            item2Description = "请确认信用卡、现金、转账等实际可用的付款方式。",
            item3Title = "卡片额度·海外支付设置",
            item3Description = "付款前请确认卡片额度及是否设置了海外使用限制。",
            item4Title = "保险直付·GOP",
            item4Description = "请提前确认保险公司与医院之间是否可直接结算（GOP）。",
            item5Title = "付款地点",
            item5Description = "确认在急诊、门诊、住院等哪个地方收费会更方便。",
        ...
        val Ja = PaymentMethodCheckStrings(
            ...
            item2Title = "利用可能な決済手段",
            item2Description = "カード、現金、振込など実際に利用できる決済手段を確認してください。",
            item3Title = "カード限度額・海外決済設定",
            item3Description = "支払い前にカードの利用限度額と海外利用制限の有無を確認してください。",
            item4Title = "保険直接請求・GOP",
            item4Description = "保険会社と病院間の直接精算（GOP）が可能か事前に確認してください。",
            item5Title = "支払い場所",
            item5Description = "救急、外来、入院など、どこで支払うか確認しておくとより便利です。",
...
data class MedicationScheduleStrings(
    ...
    companion object {
        val Ko = MedicationScheduleStrings(
            ...
            item1Title = "약 이름·복용 목적",
            item1Description = "처방받은 약 이름과 복용 목적을 확인해두세요.",
            item2Title = "용량·복용 횟수",
            item2Description = "1회 복용량과 하루 복용 횟수를 정확히 확인하세요.",
            item3Title = "복용 시간·식전·식후",
            item3Description = "정해진 복용 시간과 식전·식후 여부를 놓치지 않도록 확인하세요.",
            item4Title = "복용 기간·보관 방법",
            item4Description = "며칠간 복용하는지와 올바른 보관 방법을 함께 확인하세요.",
            item5Title = "복용 누락·이상반응 시 대처",
            item5Description = "복용을 놓쳤거나 이상반응이 나타났을 때 대처 방법을 확인해두세요.",
        ...
        val En = MedicationScheduleStrings(
            ...
            item1Title = "Medication Name & Purpose",
            item1Description = "Check the name and purpose of your prescribed medication.",
            item2Title = "Dosage & Frequency",
            item2Description = "Check the exact dose per intake and how many times a day to take it.",
            item3Title = "Timing & Before/After Meals",
            item3Description = "Check the scheduled times and whether to take it before or after meals.",
            item4Title = "Duration & Storage",
            item4Description = "Check how many days to take it and how to store it properly.",
            item5Title = "Missed Dose & Side Effects",
            item5Description = "Know what to do if you miss a dose or notice a side effect.",
        ...
        val Zh = MedicationScheduleStrings(
            ...
            item1Title = "药名·服用目的",
            item1Description = "请确认所开处方药的名称及服用目的。",
            item2Title = "剂量·服用次数",
            item2Description = "请准确确认每次服用剂量及每日服用次数。",
            item3Title = "服用时间·餐前餐后",
            item3Description = "请确认既定服用时间及餐前、餐后服用与否。",
            item4Title = "服用期间·保管方法",
            item4Description = "请一并确认服用天数与正确的保管方法。",
            item5Title = "漏服·不良反应应对",
            item5Description = "请提前了解漏服或出现不良反应时的应对方法。",
        ...
        val Ja = MedicationScheduleStrings(
            ...
            item1Title = "薬の名前・服用目的",
            item1Description = "処方された薬の名前と服用目的を確認しておいてください。",
            item2Title = "用量・服用回数",
            item2Description = "1回の服用量と1日の服用回数を正確に確認してください。",
            item3Title = "服用時間・食前食後",
            item3Description = "決められた服用時間と食前・食後の別を確認してください。",
            item4Title = "服用期間・保管方法",
            item4Description = "服用日数と正しい保管方法を合わせて確認してください。",
            item5Title = "飲み忘れ・副作用時の対処",
            item5Description = "飲み忘れや副作用が出た場合の対処法を確認しておいてください。",
...
data class PostTreatmentPrecautionsStrings(
    ...
    companion object {
        val Ko = PostTreatmentPrecautionsStrings(
            ...
            item1Title = "식사·샤워·운동 가능 시점",
            item1Description = "언제부터 식사, 샤워, 운동이 가능한지 확인하세요.",
            item2Title = "피해야 할 활동",
            item2Description = "회복 중 피해야 할 활동이나 자세를 확인하세요.",
            item3Title = "이상 증상·응급 기준",
            item3Description = "바로 병원에 연락해야 하는 이상 증상과 응급 기준을 확인하세요.",
            item4Title = "추적진료·재검 일정",
            item4Description = "추적진료나 재검사가 필요한지, 일정은 언제인지 확인하세요.",
            item5Title = "비행 가능 시점·이동 주의사항",
            item5Description = "비행기 탑승이 가능한 시점과 이동 중 주의사항을 확인하세요.",
        ...
        val En = PostTreatmentPrecautionsStrings(
            ...
            item1Title = "When You Can Eat, Shower, Exercise",
            item1Description = "Check when you can start eating, showering, or exercising.",
            item2Title = "Activities to Avoid",
            item2Description = "Check which activities or postures to avoid while recovering.",
            item3Title = "Warning Signs & Emergency Criteria",
            item3Description = "Check the warning signs that require you to contact the hospital right away.",
            item4Title = "Follow-up Visit & Retest Schedule",
            item4Description = "Check whether a follow-up visit or retest is needed, and when.",
            item5Title = "When You Can Fly & Travel Precautions",
            item5Description = "Check when you're cleared to fly and any travel precautions.",
        ...
        val Zh = PostTreatmentPrecautionsStrings(
            ...
            item1Title = "可进食·洗澡·运动的时间",
            item1Description = "请确认何时可以开始进食、洗澡、运动。",
            item2Title = "应避免的活动",
            item2Description = "请确认恢复期间应避免的活动或姿势。",
            item3Title = "异常症状·紧急标准",
            item3Description = "请确认需要立即联系医院的异常症状及紧急标准。",
            item4Title = "复诊·复查日程",
            item4Description = "请确认是否需要复诊或复查，以及具体日程。",
            item5Title = "可乘机时间·出行注意事项",
            item5Description = "请确认可以乘坐飞机的时间及出行中的注意事项。",
        ...
        val Ja = PostTreatmentPrecautionsStrings(
            ...
            item1Title = "食事・シャワー・運動が可能な時期",
            item1Description = "いつから食事、シャワー、運動が可能か確認してください。",
            item2Title = "避けるべき活動",
            item2Description = "回復中に避けるべき活動や姿勢を確認してください。",
            item3Title = "異常症状・救急基準",
            item3Description = "すぐに病院へ連絡すべき異常症状と救急基準を確認してください。",
            item4Title = "追跡診療・再検査の日程",
            item4Description = "追跡診療や再検査が必要か、日程はいつか確認してください。",
            item5Title = "搭乗可能時期・移動時の注意事項",
            item5Description = "飛行機に搭乗できる時期と移動中の注意事項を確認してください。",
...
data class EnglishDocumentsResultsStrings(
    ...
    companion object {
        val Ko = EnglishDocumentsResultsStrings(
            ...
            item1Title = "영문 진단서·소견서",
            item1Description = "본국 제출용 영문 진단서·소견서 발급이 가능한지 확인하세요.",
            item2Title = "검사결과·영상자료",
            item2Description = "검사결과지와 영상자료(CD·파일)를 함께 받을 수 있는지 확인하세요.",
            item3Title = "처방전·복약안내·퇴원요약",
            item3Description = "처방전, 복약안내문, 퇴원요약서를 영문으로 받을 수 있는지 확인하세요.",
            item4Title = "발급 시간·비용",
            item4Description = "서류 발급에 걸리는 시간과 추가 비용이 있는지 확인하세요.",
            item5Title = "이메일·디지털 수령",
            item5Description = "출국 후에도 이메일이나 디지털 파일로 받을 수 있는지 확인하세요.",
        ...
        val En = EnglishDocumentsResultsStrings(
            ...
            item1Title = "English Medical Certificate/Opinion",
            item1Description = "Check whether an English medical certificate or opinion can be issued for your home country.",
            item2Title = "Test Results & Imaging",
            item2Description = "Check whether you can receive test results along with imaging files (CD/digital).",
            item3Title = "Prescription, Medication Guide & Discharge Summary",
            item3Description = "Check whether the prescription, medication guide, and discharge summary can be issued in English.",
            item4Title = "Issuance Time & Cost",
            item4Description = "Check how long document issuance takes and whether there's an extra fee.",
            item5Title = "Email & Digital Delivery",
            item5Description = "Check whether documents can still be sent by email or digital file after you leave.",
        ...
        val Zh = EnglishDocumentsResultsStrings(
            ...
            item1Title = "英文诊断书·意见书",
            item1Description = "请确认能否开具用于本国提交的英文诊断书或意见书。",
            item2Title = "检查结果·影像资料",
            item2Description = "请确认能否一并领取检查结果单及影像资料（光盘·文件）。",
            item3Title = "处方·服药指南·出院总结",
            item3Description = "请确认处方、服药指南、出院总结能否开具英文版。",
            item4Title = "开具时间·费用",
            item4Description = "请确认文件开具所需时间及是否产生额外费用。",
            item5Title = "邮件·电子文件领取",
            item5Description = "请确认离境后能否通过邮件或电子文件方式领取。",
        ...
        val Ja = EnglishDocumentsResultsStrings(
            ...
            item1Title = "英文診断書・所見書",
            item1Description = "本国提出用の英文診断書・所見書が発行可能か確認してください。",
            item2Title = "検査結果・画像資料",
            item2Description = "検査結果書と画像資料（CD・ファイル）を一緒に受け取れるか確認してください。",
            item3Title = "処方箋・服薬案内・退院サマリー",
            item3Description = "処方箋、服薬案内、退院サマリーを英文で受け取れるか確認してください。",
            item4Title = "発行時間・費用",
            item4Description = "書類発行にかかる時間と追加費用の有無を確認してください。",
            item5Title = "メール・デジタル受け取り",
            item5Description = "出国後もメールやデジタルファイルで受け取れるか確認してください。",
...
data class AirportDeparturePreparationStrings(
    ...
    companion object {
        val Ko = AirportDeparturePreparationStrings(
            bannerTitle = "귀국·공항 준비",
            bannerSubtitle = "약 반입 제한과 귀국 전 필요한 준비 항목을 미리 확인하세요.",
            checklistTitle = "출국 전 체크리스트",
            item1Title = "귀국 국가 의약품 반입 규정",
            item1Description = "귀국하는 국가의 의약품 반입 허용 여부와 규정을 미리 확인하세요.",
            item2Title = "처방전·진단서 휴대",
            item2Description = "공항 검색대에서 필요할 수 있는 처방전과 진단서를 함께 챙기세요.",
            item3Title = "액체약·주사기·의료용품 기내반입",
            item3Description = "액체약, 주사기 등 의료용품의 기내 반입 기준을 확인하세요.",
            item4Title = "보관·운송 조건",
            item4Description = "약의 온도 등 보관·운송 조건을 지켜 이동 중 변질을 막으세요.",
            item5Title = "시차 반영 복용 일정",
            item5Description = "시차를 반영해 복용 시간을 다시 계산해두세요.",
            noticeText = "반입 제한 품목과 세관 규정은 국가마다 다르니 항공사·세관 안내를 확인해 주세요."
        )
        val En = AirportDeparturePreparationStrings(
            bannerTitle = "Departure & Airport Prep",
            ...
            item1Title = "Medication Import Rules for Your Country",
            item1Description = "Check your home country's rules on bringing medication into the country.",
            item2Title = "Carry Prescription & Medical Certificate",
            item2Description = "Bring your prescription and medical certificate — you may need them at security.",
            item3Title = "Liquid Medicine, Syringes & Supplies in Carry-on",
            item3Description = "Check the carry-on rules for liquid medicine, syringes, and other medical supplies.",
            item4Title = "Storage & Transport Conditions",
            item4Description = "Follow temperature and other storage/transport conditions to keep medication from spoiling.",
            item5Title = "Time Zone-Adjusted Dosing Schedule",
            item5Description = "Recalculate your dosing times to account for the time difference.",
        ...
        val Zh = AirportDeparturePreparationStrings(
            ...
            item1Title = "回国国家药品携带规定",
            item1Description = "请提前确认您回国所在国家对药品携带的许可及规定。",
            item2Title = "随身携带处方·诊断书",
            item2Description = "请携带机场安检时可能需要的处方和诊断书。",
            item3Title = "液体药·注射器·医疗用品随身携带",
            item3Description = "请确认液体药、注射器等医疗用品的随身携带标准。",
            item4Title = "保管·运输条件",
            item4Description = "请遵守温度等保管、运输条件，防止途中药品变质。",
            item5Title = "考虑时差的服药日程",
            item5Description = "请根据时差重新计算服药时间。",
        ...
        val Ja = AirportDeparturePreparationStrings(
            ...
            item1Title = "帰国先の医薬品持ち込み規定",
            item1Description = "帰国する国の医薬品持ち込み可否と規定を事前に確認してください。",
            item2Title = "処方箋・診断書の携帯",
            item2Description = "空港の保安検査で必要になる場合がある処方箋と診断書を携帯してください。",
            item3Title = "液体薬・注射器・医療用品の機内持ち込み",
            item3Description = "液体薬、注射器など医療用品の機内持ち込み基準を確認してください。",
            item4Title = "保管・輸送条件",
            item4Description = "温度など保管・輸送条件を守り、移動中の変質を防いでください。",
            item5Title = "時差を考慮した服薬スケジュール",
            item5Description = "時差を踏まえて服用時間を再計算しておいてください。",
...
data class HospitalLocationCheckinStrings(
    ...
    // itemCardDescription의 선행 부분(핑크 강조용) — itemCardDescription은 반드시 이 문자열로 시작해야 한다.
    val itemCardDescriptionHighlight: String,
    ...
    companion object {
        val Ko = HospitalLocationCheckinStrings(
            ...
            itemCardDescriptionHighlight = "병원 위치, 교통편, 주차 정보와 경로 안내",
            sectionTitle = "접수 절차",
            step1Title = "접수 위치 확인",
        ...
        val En = HospitalLocationCheckinStrings(
            ...
            itemCardDescription = "Hospital location, transportation, parking, and directions — check them all here.",
            itemCardDescriptionHighlight = "Hospital location, transportation, parking, and directions",
        ...
        val Zh = HospitalLocationCheckinStrings(
            ...
            itemCardDescription = "医院位置、交通方式、停车信息及路线指引，点击即可查看。",
            itemCardDescriptionHighlight = "医院位置、交通方式、停车信息及路线指引",
            sectionTitle = "挂号流程",
            step1Title = "确认挂号地点",
        ...
        val Ja = HospitalLocationCheckinStrings(
            ...
            itemCardDescriptionHighlight = "病院の場所、交通手段、駐車場情報、経路案内",
            sectionTitle = "受付手続き",
            step1Title = "受付場所の確認",
...
// S-06 STEP03 합본 페이지의 "방문·접수 준비" 메모 카드 섹션 전용(리프 상세 화면 없음 — 합본 페이지에서만 쓰인다).
data class VisitReceptionPreparationStrings(
    val sectionTitle: String,
    val item1Title: String,
    val item1Description: String,
    val item2Title: String,
    ...
    companion object {
        val Ko = VisitReceptionPreparationStrings(
            sectionTitle = "방문·접수 준비",
            item1Title = "여권·신분증",
            item1Description = "여권 또는 외국인등록증으로 신원을 확인할 수 있도록 준비하세요.",
            item2Title = "예약 정보",
            item2Description = "예약 일시와 진료과를 다시 한번 확인하세요.",
            item3Title = "접수 위치",
            item3Description = "국제진료센터인지 외래 접수처인지 미리 확인해두세요.",
            item4Title = "예약 시간·도착 시각",
            item4Description = "예약 시간과 병원 도착 예정 시간을 함께 확인해두면 접수가 수월해요."
        )
        val En = VisitReceptionPreparationStrings(
            sectionTitle = "Visit & Check-in Prep",
            item1Title = "Passport & ID",
            item1Description = "Have your passport or foreigner registration card ready for identity verification.",
            item2Title = "Reservation Info",
            item2Description = "Double-check your appointment date, time, and department.",
            item3Title = "Check-in Location",
            item3Description = "Check in advance whether it's the International Clinic or the outpatient reception desk.",
            item4Title = "Appointment & Arrival Time",
            item4Description = "Knowing both your appointment time and expected arrival time makes check-in easier."
        )
        val Zh = VisitReceptionPreparationStrings(
            sectionTitle = "到院挂号准备",
            item1Title = "护照·身份证件",
            item1Description = "请准备好护照或外国人登记证以供身份核实。",
            item2Title = "预约信息",
            item2Description = "请再次确认预约日期时间及诊疗科室。",
            item3Title = "挂号地点",
            item3Description = "请提前确认是国际诊疗中心还是门诊挂号处。",
            item4Title = "预约与到达时间",
            item4Description = "同时确认预约时间与预计到达医院的时间，可让挂号更顺利。"
        )
        val Ja = VisitReceptionPreparationStrings(
            sectionTitle = "来院・受付の準備",
            item1Title = "パスポート・身分証",
            item1Description = "パスポートまたは外国人登録証で本人確認ができるよう準備してください。",
            item2Title = "予約情報",
            item2Description = "予約日時と診療科をもう一度確認してください。",
            item3Title = "受付場所",
            item3Description = "国際診療センターか外来受付か、事前に確認しておいてください。",
            item4Title = "予約・到着時刻",
            item4Description = "予約時刻と病院への到着予定時刻を合わせて確認しておくと受付がスムーズです。"
        )
    }
}
...
data class TreatmentExaminationStrings(
    ...
    val briefingLabelAllergy: String,
    val briefingLabelMedication: String,
    ...
    val translateToKoreanButtonLabel: String,
    val hideTranslationButtonLabel: String,
    val translationErrorMessage: String,
    val datePickerConfirmLabel: String,
    val datePickerCancelLabel: String,
    ...
    companion object {
        val Ko = TreatmentExaminationStrings(
            ...
            briefingSectionTitle = "내 진료 카드",
            briefingLabelVisitPurpose = "방문 목적",
            briefingLabelSymptoms = "현재 증상",
            briefingLabelAllergy = "알레르기",
            briefingLabelMedication = "복용 중인 약",
            briefingLabelReturnDate = "귀국·체류 일정",
            briefingLabelMemo = "꼭 전달할 내용",
            editContentDescription = "수정",
            saveContentDescription = "저장",
            translateToKoreanButtonLabel = "한국어로 보기",
            hideTranslationButtonLabel = "번역 접기",
            translationErrorMessage = "번역에 실패했습니다. 잠시 후 다시 시도해주세요.",
            datePickerConfirmLabel = "확인",
            datePickerCancelLabel = "취소",
            datePickerTitle = "날짜 선택",
            todayChecklistTitle = "오늘 확인할 3가지",
            todayItem1Title = "정확한 진료·검사명",
            todayItem1Description = "오늘 실제로 받는 진료·검사·시술 이름을 확인하세요.",
            todayItem2Title = "검사 전 준비·주의사항",
            todayItem2Description = "금식, 복용약, 준비물 등 검사 전 주의사항을 확인하세요.",
            todayItem3Title = "결과 확인 시점·수령 방법",
            todayItem3Description = "검사 결과를 언제, 어떤 방법으로 확인할 수 있는지 확인하세요.",
            inquirySectionTitle = "귀국 후 문의 채널",
            inquiry2Title = "Medical Korea 공식 안내",
        ...
        val En = TreatmentExaminationStrings(
            ...
            briefingSectionTitle = "My Treatment Card",
            briefingLabelVisitPurpose = "Visit Purpose",
            briefingLabelSymptoms = "Current Symptoms",
            briefingLabelAllergy = "Allergies",
            briefingLabelMedication = "Current Medications",
            briefingLabelReturnDate = "Return & Stay Schedule",
            briefingLabelMemo = "Must-Share Notes",
            editContentDescription = "Edit",
            saveContentDescription = "Save",
            translateToKoreanButtonLabel = "View in Korean",
            hideTranslationButtonLabel = "Hide Translation",
            translationErrorMessage = "Translation failed. Please try again shortly.",
            datePickerConfirmLabel = "Confirm",
            ...
            todayItem2Title = "Pre-Exam Prep & Precautions",
            todayItem2Description = "Check fasting, medications, and other precautions before your exam.",
            todayItem3Title = "Result Timing & How to Receive",
            todayItem3Description = "Check when and how you can check and receive your results.",
            inquirySectionTitle = "Inquiry Channels After Return",
            inquiry2Title = "Medical Korea Official Guide",
        ...
        val Zh = TreatmentExaminationStrings(
            ...
            briefingSectionTitle = "我的诊疗卡",
            briefingLabelVisitPurpose = "访问目的",
            briefingLabelSymptoms = "现有症状",
            briefingLabelAllergy = "过敏",
            briefingLabelMedication = "服用中的药物",
            briefingLabelReturnDate = "回国·停留日程",
            briefingLabelMemo = "务必转达的内容",
            editContentDescription = "编辑",
            saveContentDescription = "保存",
            translateToKoreanButtonLabel = "查看韩语翻译",
            hideTranslationButtonLabel = "收起翻译",
            translationErrorMessage = "翻译失败，请稍后重试。",
            datePickerConfirmLabel = "确认",
            datePickerCancelLabel = "取消",
            datePickerTitle = "选择日期",
            todayChecklistTitle = "今天要确认的3件事",
            todayItem1Title = "准确的诊疗·检查名称",
            todayItem1Description = "请确认今天实际接受的诊疗、检查、施术名称。",
            todayItem2Title = "检查前准备·注意事项",
            todayItem2Description = "请确认禁食、服药等检查前的注意事项。",
            todayItem3Title = "结果确认时间·领取方式",
            todayItem3Description = "请确认何时以及如何确认并领取检查结果。",
            inquirySectionTitle = "回国后咨询渠道",
            inquiry2Title = "Medical Korea官方指南",
        ...
        val Ja = TreatmentExaminationStrings(
            ...
            briefingSectionTitle = "私の診療カード",
            briefingLabelVisitPurpose = "訪問目的",
            briefingLabelSymptoms = "現在の症状",
            briefingLabelAllergy = "アレルギー",
            briefingLabelMedication = "服用中の薬",
            briefingLabelReturnDate = "帰国・滞在スケジュール",
            briefingLabelMemo = "必ず伝えたいこと",
            editContentDescription = "編集",
            saveContentDescription = "保存",
            translateToKoreanButtonLabel = "韓国語で見る",
            hideTranslationButtonLabel = "翻訳を閉じる",
            translationErrorMessage = "翻訳に失敗しました。しばらくしてからもう一度お試しください。",
            datePickerConfirmLabel = "確認",
            datePickerCancelLabel = "キャンセル",
            datePickerTitle = "日付の選択",
            todayChecklistTitle = "今日確認する3つのこと",
            todayItem1Title = "正確な診療・検査名",
            todayItem1Description = "本日実際に受ける診療・検査・施術の名前を確認してください。",
            todayItem2Title = "検査前の準備・注意事項",
            todayItem2Description = "絶食、服薬など検査前の注意事項を確認してください。",
            todayItem3Title = "結果確認の時期・受け取り方法",
            todayItem3Description = "検査結果をいつ、どのように確認・受け取りできるか確認してください。",
            inquirySectionTitle = "帰国後の問い合わせ先",
            inquiry2Title = "Medical Korea公式案内",
